//string[] heroes = { "Hans", "Grete", "Spiderman", "Batman", "Luke" };
//string[] villains = { "Voldemort", "Dracula", "Joker", "Sauron", "Vanapagan" };
using System.ComponentModel.Design;

string folderPath = @"C:\Data";
string heroFile = "heroes.txt";
string villainFile = "villain.txt";

string[] heroes = File.ReadAllLines(Path.Combine(folderPath, heroFile));
string[] villains = File.ReadAllLines(Path.Combine(folderPath, villainFile));
string[] weapon = { "magic wand", "plastic fork", "banana", "vits" };
...
Console.WriteLine($"Today {villain} with  ({villainHP} HP) with {villainWeapon} treis to take over the world");
